 ...
 * 
 * Second graphite backend added to allow sending to two graphites.
 *
 * To enable this backend, include 'anotherGraphite' in the backends
 * configuration array:
 *
 *   backends: ['anotherGraphite']
 *
 * This backend supports the following config options:
 *
 *   anotherGraphiteHost: Hostname of graphite server.
 *   anotherGraphitePort: Port to contact graphite server at.
 */
...
exports.init = function graphite_init(startup_time, config, events) {
  debug = config.debug;
  graphiteHost = config.anotherGraphiteHost;
  graphitePort = config.anotherGraphitePort;
